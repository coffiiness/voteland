...
public class POST_specs {
	...
	@Test
	void voteType_속성이_지정되지_않으면_ERROR를_반환한다(@Autowired UserFixture userFixture,
			@Autowired VoteFixture voteFixture) {
		// Arrange
		String token = userFixture.createUserAndGetToken();
		CreateVoteRequest request = new CreateVoteRequest(
	...
	@Test
	void options_속성이_지정되지_않으면_ERROR를_반환한다(@Autowired UserFixture userFixture,
			@Autowired VoteFixture voteFixture) {
		// Arrange
		String token = userFixture.createUserAndGetToken();
		CreateVoteRequest request = new CreateVoteRequest(
	...
	@Test
	void options_속성이_1개만_있으면_ERROR를_반환한다(@Autowired UserFixture userFixture,
			@Autowired VoteFixture voteFixture) {
		// Arrange
		String token = userFixture.createUserAndGetToken();
		CreateVoteRequest request = new CreateVoteRequest(
	...
	@Test
	void deadline_속성이_지정되지_않으면_ERROR를_반환한다(@Autowired UserFixture userFixture,
			@Autowired VoteFixture voteFixture) {
		// Arrange
		String token = userFixture.createUserAndGetToken();
		CreateVoteRequest request = new CreateVoteRequest(
	...
	@Test
	void deadline_속성이_과거_시간이면_ERROR를_반환한다(@Autowired UserFixture userFixture,
			@Autowired VoteFixture voteFixture) {
		// Arrange
		String token = userFixture.createUserAndGetToken();
		CreateVoteRequest request = new CreateVoteRequest(
	...
	@Test
	void deadline_속성이_미래_시간이면_SUCCESS를_반환한다(@Autowired UserFixture userFixture,
			@Autowired VoteFixture voteFixture) {
		// Arrange
		String token = userFixture.createUserAndGetToken();
		CreateVoteRequest request = new CreateVoteRequest(
