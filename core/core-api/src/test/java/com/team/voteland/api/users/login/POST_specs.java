...
public class POST_specs {
    ...
    @Test
    void 존재하지_않는_이메일로_로그인하면_401_Unauthorized_상태코드를_반환한다(@Autowired UserFixture fixture) {
        // Arrange
    ...
    @Test
    void 잘못된_비밀번호로_로그인하면_401_Unauthorized_상태코드를_반환한다(@Autowired UserFixture fixture) {
        // Arrange
        String email = fixture.randomEmail();
